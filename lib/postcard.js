 ...
 */
async function renderPostcard({ title, coordsText, place, editionNumber }) {
  await ensureWasm();
          ...
          props: {
            ...
            children: [
              ...
              },
              {
                type: 'div',
                props: {
                  style: { fontFamily: 'JetBrains Mono', fontSize: 17, letterSpacing: 1, color: '#6f6a5c' },
                  children: coordsText || '',
                },
              },
              {
            ...
            children: [
              {
                type: 'div',
                props: {
                  style: { fontFamily: 'Alex Brush', fontSize: 58, color: '#14140f' },
